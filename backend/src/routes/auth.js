...
router.get('/admin/customer-operator-setting', authenticateToken, getCustomerOperatorSetting);
router.post('/admin/customer-operator-setting', authenticateToken, updateCustomerOperatorSetting);
