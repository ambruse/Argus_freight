...
export default function AdminCallEnquiries() {
  ...
  return (
    <AppLayout title="All Call Enquiries" subtitle="Overview of all calls logged by Calling Agents.">
      <div className="glass rounded-2xl shadow-card overflow-hidden">
        <div className="p-4 border-b border-white/[0.06] flex items-center justify-between">
          <h3 className="text-sm font-semibold tracking-widest text-muted uppercase">
            All Logged Calls ({enquiries.length})
          </h3>
        </div>
          ...
          <table className="data-table">
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={8} className="text-center py-8 text-muted">No calls logged yet.</td></tr>
              ) : (
                enquiries.map((e) => (
                  <tr key={e.id}>
