  ...
  ...(process.env.NODE_ENV !== 'production' && {
    ...
    async rewrites() {
      ...
      return [
        ...
        { source: "/contact",          destination: "/landing/index.html" },
        { source: "/chairman-message", destination: "/landing/index.html" },
      ];
    },
  }),

  // Apply standard browser security headers to all routes (dev only;
  // in production Express sets these headers)
  ...(process.env.NODE_ENV !== 'production' && {
    async headers() {
      return [
        {
