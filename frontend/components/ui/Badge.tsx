...
const STATUS_CONFIG: Record<ShipmentStatus, { dot: string; bg: string; border: string; text: string }> = {
  "Awaiting Approval": { dot: "#F97316", bg: "rgba(249,115,22,0.10)", border: "rgba(249,115,22,0.22)", text: "#F97316" },
...
const PULSE_STATUSES: ShipmentStatus[] = ["Awaiting Approval", "Pending", "Files Pending", "Return Pending"];
