            ...
            <div className="phone-dropdown-wrapper">
              ...
              <div className="phone-dropdown-menu">
                <div className="phone-dropdown-item">
                  ...
                  <a href="https://www.whatsapp.com" target="_blank" rel="noopener noreferrer" className="phone-whatsapp-icon" title="Chat on WhatsApp">
                ...
                <div className="phone-dropdown-item">
                  <a href="tel:97377034555" className="phone-item-info">
                ...
                <div className="phone-dropdown-item">
                  <a href="tel:+9197423798388" className="phone-item-info">
