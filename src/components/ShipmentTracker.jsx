...
// Preset Mock Database — ONLY for offline/dev fallback when backend is unreachable.
// Do NOT add real DB shipment refs here; they must always be resolved from the database.
const MOCK_DATA = {
  'RFQ-2026-9015': {
        ...
        <form onSubmit={handleSubmit} className="argus-input-group">
          <div className="argus-input-wrapper">
            ...
            <input
              ...
              placeholder="Enter Reference Number (e.g. ARG-2408261 or ARG-2408261-1)..."
              value={rfqInput}
